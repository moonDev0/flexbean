var game = {
    ...
    setHandlers: function() {
      ...
      $('#colorblind').on('change', function() {
        ...
        if (game.colorblind == 'true') {
          $('.bowl, .bean').addClass('cb-friendly');
        } else {
          $('.bowl, .bean').removeClass('cb-friendly');
        }
      });
    ...
    loadLevel: function(level) {
      ...
      for (var i = 0; i < string.length; i++) {
        ...
        $('<div/>').addClass('bg animated pulse infinite').appendTo(bean);
    ...
    win: function() {
      ...
      $('#code').val(solution);
      $('#share').show();
      $('.bean .bg').removeClass('pulse').addClass('bounce');
    },
